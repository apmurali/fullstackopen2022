...
const App = () => {
  ...
  const [votes, setVotes] = useState(Array.from(Array(anecdotes.length), () => 0)) //creating an array of zeroes as per ES6
  const getRandomAnecdote = () => {
    setSelected(getRandomInt(anecdotes.length))
    console.log(selected);
  }
//from https://www.codingdeft.com/posts/react-usestate-array/
  const incrementVote = () => {
